...
Matrix* tridiagonal_algorithm(Matrix* matrix, Matrix* vector) {
    Matrix* PQ, * result;
    int i;
    PQ = create_matrix();
...
Matrix* (* const TDMA)(Matrix*, Matrix*) = tridiagonal_algorithm;
...
int main(void) {
    ...
    fmatrix = fopen("lab1-2m.txt", "r");
    fvector = fopen("lab1-2v.txt", "r");
